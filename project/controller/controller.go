...
var (
	...
	status_chan								= make(chan utilities.StatusMessage, 3)
...
func controller_state_machine(
	...
	for {
		...
		case utilities.State_master:
			...
			controller_modes.Master(&state, &current_elevator, controller_id, elev_to_ctrl_chan, elev_to_ctrl_button_chan, ctrl_to_elev_chan, ctrl_to_elev_cab_chan, ctrl_to_network_chan, ODM_to_network_chan, net)
